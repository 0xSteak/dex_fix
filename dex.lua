...
local function Load(Obj, Url)
    ...
    local function LoadScripts(Script)
        if Script.ClassName == "Script" or Script.ClassName == "LocalScript" then
            if Script.Name == "Selection" then 
                task.spawn(GiveOwnGlobals(loadstring(game:HttpGet("https://raw.githubusercontent.com/0xSteak/dex_fix/main/selection.lua"), "=" .. Script:GetFullName()), Script)) 
            else
